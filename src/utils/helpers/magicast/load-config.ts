import { ProxifiedModule, ProxifiedObject, MagicastError, parseExpression, generateCode, Proxified } from "magicast";
import { Program, VariableDeclarator } from "./type";

export function getConfigFromVariableDeclaration(magicast: ProxifiedModule<any>): {
