import { TBonitaConfigSchema, promptForTWConfig } from "@/utils/config/config";
import { getPackageManager, packageExecCommand } from "@/utils/helpers/get-package-manager";
import { loader, system, print, writeFileAsync, fileExists } from "gluegun-toolbox";
import { updateTwPlugins, tailwind_config_template, tailwind_base_css } from "../../config/consts";
